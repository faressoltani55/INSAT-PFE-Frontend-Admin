...
import { YearComponent } from './services/year/year.component';
...
@NgModule({
  declarations: [AddYearComponent, AddSessionComponent, AddSoutenanceComponent, YearComponent, SessionsListingComponent, SoutenancesListingComponent],
  imports: [
    CommonModule,
